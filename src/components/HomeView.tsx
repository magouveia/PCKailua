...
interface HomeViewProps {
  onNavigate: (view: 'career' | 'organogram' | 'job-descriptions' | 'performance' | 'org-chart' | 'recruitment') => void;
}
...
export const HomeView: React.FC<HomeViewProps> = ({ onNavigate }) => {
  return (
    <div className="min-h-screen bg-brand-dark flex flex-col items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="flex flex-wrap justify-center gap-4 md:gap-6 max-w-5xl w-full z-10 px-4">
        ...
        <motion.button
          ...
          className="group relative w-[calc(50%-0.5rem)] sm:w-[calc(33.333%-1rem)] aspect-square max-w-[260px] bg-brand-cream rounded-2xl p-6 flex flex-col items-center justify-center text-center shadow-2xl hover:shadow-brand-tan/20 transition-all duration-500 hover:-translate-y-2 overflow-hidden"
        >
